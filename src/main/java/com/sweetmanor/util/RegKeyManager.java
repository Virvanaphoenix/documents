...
/**
 * Windows注册表工具类：网上下载的，使用cmd命令查询，暂时不研究
 * 
...
public class RegKeyManager {
	...
	protected boolean add(String loc, String name, String dType, String value)
			throws Exception {
